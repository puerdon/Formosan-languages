...
@st.cache
def get_basic_stats():
  d = pd.read_pickle('data/stats_of_each_text_20221228.pkl', compression="gzip")
  return d

@st.cache
def get_each_text_stats():
  d = pd.read_pickle('data/stats_of_each_text_with_subtext_20221228.pkl', compression="gzip")
  return d
